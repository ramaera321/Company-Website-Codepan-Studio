        ...
        <div class="col-sm-12">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body add-blog px-4 tambah-admin">
                    <form action="/portfoliosub/save" method="post">
                        <?= csrf_field(); ?>
            ...
            <div class="card shadow">
                <div class="data-blog table-responsive">
                    <table class="table table-bordered table-striped table-hover mb-0">
                        ...
                        <tbody>
                            <?php $i = 1; ?>
                            <?php foreach ($portfolio_sub_kategori as $sub_kategori) : ?>
                                <tr>
                                    <th scope="row"><?= $i++; ?></th>
                                    <td><?= $sub_kategori['nama_sub']; ?></td>
                                    <td>
                                        <a href="/update_port_sub/<?= $sub_kategori['id']; ?>" class=" btn bg-warning"></a>
                                        <form action="/port_sub/<?= $sub_kategori['id']; ?>" method="post" class="d-inline">
                                            <?= csrf_field(); ?>
