                ...
                <div class="card-body add-blog px-4 tambah-admin">
                    <form action="/tag/save" method="post">
                        ...
                        <div class="input-group mb-3 cabang">
                            ...
                            <input type="text" class="rounded-right form-control<?= ($validation->hasError('nama_tag')) ? ' is-invalid' : ''; ?>" placeholder="" aria-label="Username" aria-describedby="basic-addon1" name="nama_tag" value="<?= old('nama_tag'); ?>">
                        ...
                        <tbody>
                            ...
                            <?php foreach ($tag as $tag) : ?>
                                <tr>
                                    ...
                                    <td><?= $tag['nama_tag']; ?></td>
                                    <td>
                                        <a href="/update_tag/<?= $tag['id']; ?>" class=" btn bg-warning"></a>
