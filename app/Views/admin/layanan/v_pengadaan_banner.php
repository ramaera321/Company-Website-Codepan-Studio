    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body add-blog px-4 tambah-admin">
            <form action="/banner/update/<?= $banner['id']; ?>" method="post" enctype="multipart/form-data">
                <?= csrf_field(); ?>
                <input type="hidden" name="layanan" value="pengadaan">
                <input type="hidden" name="link" value="pengadaan">
                <div class="form-group">
                    <label for="exampleFormControlTextarea1">Deskripsi</label>
                    <textarea class="form-control text rounded<?= ($validation->getError('deskripsi')) ? ' is-invalid' : ''; ?>" id="exampleFormControlTextarea" name="deskripsi" value=""><?= $banner['deskripsi']; ?></textarea>
