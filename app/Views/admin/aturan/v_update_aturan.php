        ...
        <div class="col-sm-12">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body add-blog">
                    <form action="/pasal/update/<?= $pasal['id']; ?>" method="post">
                        <input type="hidden" name="id" value="<?= $pasal['id']; ?>">
                        <div class="input-group mb-3">
                            ...
                            <select class="custom-select<?= ($validation->getError('pasal')) ? ' is-invalid' : ''; ?>" id="inputGroupSelect01" name="pasal">
                                <option value="<?= (old('pasal')) ? old('pasal') : $pasal['pasal']; ?>" selected hidden><?= (old('pasal')) ? old('pasal') : $pasal['pasal']; ?></option>
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="rounded-right form-control<?= ($validation->hasError('judul')) ? ' is-invalid' : ''; ?>" placeholder="" aria-label="Username" aria-describedby="basic-addon1" name="judul" value="<?= (old('judul')) ? old('judul') : $pasal['judul']; ?>">
                            <div class="invalid-feedback">
