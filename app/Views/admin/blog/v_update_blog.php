                    ...
                    <form action="/blog/update/<?= $blog['id']; ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <select class="custom-select<?= ($validation->getError('sub_kategori')) ? ' is-invalid' : ''; ?>" id="inputGroupSelect01" name="sub_kategori">
                                <option value="<?= (old('sub_kategori')) ? old('sub_kategori') : $blog['sub_kategori']; ?>" selected hidden><?= (old('sub_kategori')) ? old('sub_kategori') : $blog['sub_kategori']; ?></option>
                        ...
                        <div class="form-group">
                            ...
                            <textarea rows="4" class="form-control rounded text<?= ($validation->getError('describ')) ? ' is-invalid' : ''; ?>" id="describ" name="describ" value=""><?= (old('describ')) ? old('describ') : $blog['describ']; ?></textarea>
                            <div class="invalid-feedback">
