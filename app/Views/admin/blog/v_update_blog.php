                ...
                <div class="card-body add-blog blog-form">
                    <form action="/blog/update/<?= $blog['id']; ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text"
                                class="form-control rounded-right<?= ($validation->getError('judul')) ? ' is-invalid' : ''; ?>"
                                aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default"
                                name="judul" value="<?= (old('judul')) ? old('judul') : $blog['judul']; ?>">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <select
                                class="custom-select<?= ($validation->getError('kategori')) ? ' is-invalid' : ''; ?>"
                                id="inputGroupSelect01" name="kategori">
                                <option value="<?= (old('kategori')) ? old('kategori') : $blog['kategori']; ?>" selected
                                    hidden><?= (old('kategori')) ? old('kategori') : $blog['kategori']; ?></option>
                        ...
                        <div class="input-group mb-3">
                            ...
                            <select
                                class="custom-select<?= ($validation->getError('sub_kategori')) ? ' is-invalid' : ''; ?>"
                                id="inputGroupSelect01" name="sub_kategori">
                                <option
                                    value="<?= (old('sub_kategori')) ? old('sub_kategori') : $blog['sub_kategori']; ?>"
                                    selected hidden>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9 checkbox">
                                ...
                                <div class="form-check mb-2 d-inline mr-4">
                                    <input class="form-check-input input-checkbox" type="checkbox" id="gridCheck1"
                                        name="tag[]" value="<?= $tag['nama_tag']; ?>"
                                        <?= (in_array($tag['nama_tag'], $data_tag)) ? 'checked' : ''; ?>>
                        ...
                        <div class="form-group">
                            ...
                            <textarea rows="4" maxlength="300"
                                class="form-control rounded text<?= ($validation->getError('describ')) ? ' is-invalid' : ''; ?>"
                                id="describ" name="describ"
                                value=""><?= (old('describ')) ? old('describ') : $blog['describ']; ?></textarea>
                            <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <textarea
                                class="form-control text<?= ($validation->getError('materi')) ? ' is-invalid' : ''; ?>"
                                id="exampleFormControlTextarea1" name="materi"
                                value=""><?= (old('materi')) ? old('materi') : $blog['materi']; ?></textarea>
                            <div class="invalid-feedback">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <select class="custom-select<?= ($validation->getError('penulis')) ? ' is-invalid' : ''; ?>"
                                id="inputGroupSelect01" name="penulis">
                                <option value="<?= (old('penulis')) ? old('penulis') : $blog['penulis']; ?>" selected
                                    hidden><?= (old('penulis')) ? old('penulis') : $blog['penulis']; ?></option>
                        ...
                        <div class="input-group mb-3">
                            ...
                            <div class="custom-file">
                                <input type="file"
                                    class="custom-file-input<?= ($validation->hasError('foto')) ? ' is-invalid' : ''; ?>"
                                    id="foto" aria-describedby="inputGroupFileAddon01" name="foto"
                                    onchange="previewImage()"
                                    value="<?= (old('foto')) ? old('foto') : $blog['foto']; ?>">
                                <div class="invalid-feedback invalid-foto blog-invalid-foto">
                                    <?= $validation->getError('foto'); ?>
                                </div>
                                <label class="custom-file-label"
                                    for="inputGroupFile01"><?= (old('foto')) ? old('foto') : $blog['foto']; ?></label>
                            </div>
                        </div>
