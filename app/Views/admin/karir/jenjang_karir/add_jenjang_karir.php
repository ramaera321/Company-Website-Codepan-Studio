        ...
        <div class="col-sm-12">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body add-blog">
                    <form action="/jenjangkarir/save" method="get">
                        <?= csrf_field(); ?>
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
                                <span class="input-group-text" id="inputGroup-sizing-default" style="width: 125px;">Jenjang Karir</span>
                            </div>
                            <input type="text" class="form-control rounded-right<?= ($validation->getError('jenjang_karir')) ? ' is-invalid' : ''; ?>" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="jenjang_karir" value="<?= old('jenjang_karir'); ?>">
