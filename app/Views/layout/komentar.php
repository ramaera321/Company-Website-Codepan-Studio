<div class="row container-testi d-flex justify-content-md-between justify-content-sm-center">
    <?php
    foreach ($komentar as $komentar) :
    ?>
    <div class="pelanggan col-md-6 row m-comment" data-aos="fade-right">
