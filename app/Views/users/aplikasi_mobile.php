...
<!-- Jumbotron Heading -->
<div id="mt" class="centered jumbotron jumbotron-fluid" style="background-image: url('../img/aplikasi-mobile/JumbotronMobile.png');">
    <div class="container">
    ...
    <div class="container" id="kunci-sukses">
        <div class="row">
            <div class="col">
                ...
                <h1 class="tag-besar">SYARAT IMPLEMENTASI APLIKASI MOBILE</h1>
