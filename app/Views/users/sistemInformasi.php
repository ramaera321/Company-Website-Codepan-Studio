 <!-- Jumbotron Heading -->
    <div class="jumbotron jumbotron-fluid" style="background-image: url('/img/Jumbotron\ SI.png');">
      <div class="container">
        <h1 class="display-4">SISTEM INFORMASI</h1>
        <p class="lead"> <center>Platform sistem informasi terbaik untuk memudahkan bisnis Anda</center></p>
          ...
          <div class="container">
              <div class="row">
                  <div class="col-md-5" id="judulSI" data-aos="fade-right">
                    ...
                    <p>Kami hadir memberikan layanan dan solusi atas permasalahan Anda. Kami menawarkan layanan sistem informasi yang kompetitif dan prima menggunakan metode yang handal dan terpercaya.</p>
                    <p><a class="hvr-bounce-to-top" href="#">Dapatkan Konsultasi Gratis <i class="fas fa-long-arrow-alt-right hvr-icon-fade" ></i></a></p>
                  </div>
                  ...
                  <div class="col-md-7" id="bullets" data-aos="fade-left">
                      <ul>
                          ...
                          <li class="bullets">
                              ...
                              <p>Sistem informasi yang handal akan membuat kinerja sistem manajemen perusahaan menjadi lebih optimal.</p>
                          </li>
                      </ul>
                      <ul>
                        <li><img src="/img/Pointer.png" alt=""></li>
                        <li class="bullets">
                            ...
                            <p>Dengan sistem informasi, data bisnis menjadi mudah untuk dikelola oleh perusahaan Anda.</p>
                        </li>
                      </ul>
                      <ul>
                        <li><img src="/img/Pointer.png" alt=""></li>
                        <li class="bullets">
                            ...
                            <p>Layanan sistem informasi berfungsi untuk mempercepat penyampaian informasi kepada calon customer atau klien.</p>
                        </li>
                      </ul>
                      <ul>
                        <li><img src="/img/Pointer.png" alt=""></li>
          ...
          <div class="container" id="kunci-sukses">
            <div class="row">
                <div class="col">
                    ...
                    <p class="capt">Sistem informasi yang handal dan terbaik, membutuhkan kerja sama dari semua pihak. Anda bisa membantu kami dalam mengimplementasikannya.</p>
                </div>
            </div><!--Akhir Row1-->
            <div class="row">
                ...
                <div class="col-lg-4" data-aos="zoom-out" data-aos-delay="300"> 
                    <figure class="figure">
                        ...
                        <figcaption class="figure-caption">
                            ...
                            <p>Sudah ada aturan proses kerja dalam institusi yang telah dibakukan dan di sahkan. (contoh: Standard Operational Procedure)</p>
                        </figcaption>
                      </figure>
                </div>
            </div><!--AKhir Row2-->
        ...
        <div class="container">
          <div class="row">
              <div class="col">
                  ...
                  <p class="capt">Inilah beberapa hasil jasa layanan kami kepada beberapa mitra. Tenaga ahli kami telah mampu menyelesaikan permasalahan dan meningkatkan kinerja perusahaan mitra kami.</p>
              </div>
          </div><!--Akhir Row1-->
