        ...
        <div class="row" id="row-card" data-aos="fade-down" data-aos-delay="200">
            ...
            <div class="col-lg-3 col-md-6 mb-4 margin-rowCard">
                <div class="card h-100">
                    ...
                    <div class="card-img-rowCard">
                        <lottie-player class="phone" src="https://assets9.lottiefiles.com/packages/lf20_tlzxty4j.json" background="transparent" speed="1" style="width: 100px; height: 100px;" loop autoplay>
                        </lottie-player>
                    </div>
                    <div class="card-body">
                        <div id="counter">
