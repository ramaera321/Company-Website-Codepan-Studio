        ...
        <div class="row" id="row-card" data-aos="fade-down" data-aos-delay="200">
            ...
            <div class="col-lg-3 col-md-6 mb-4 margin-rowCard">
                <div class="card h-100">
                    ...
                    <div class="card-img-rowCard">
                        <lottie-player class="phone" src="https://assets4.lottiefiles.com/packages/lf20_tlzxty4j.json" background="transparent" speed="1" style="width: 70px; height: auto;" loop autoplay>
                        </lottie-player>
                    </div>
                    <div class="card-body">
                        <div id="counter">
    ...
    <div class="container" id="kunci-sukses">
        <div class="row">
            <div class="col">
                ...
                <h2 class="tag-besar">SYARAT IMPLEMENTASI APLIKASI E-GOV</h2>
                <p class="capt">Aplikasi E-Gov yang handal dan terbaik, membutuhkan kerja sama dari semua pihak.
        ...
        <div class="row">
            ...
            <div class="col-lg-4" data-aos="zoom-out" data-aos-delay="300">
                <figure class="figure">
                    <img src="/assets/img/syarat-implementasi/card3.jpg" class="figure-img img-fluid rounded" alt="...">
                    <figcaption class="figure-caption">
                ...
                <div class="col-lg-4 col-md-6 porto-margin">
                    <div class="card card-portofolio h-100">
                        ...
                        <div class="img-card-container">
                            <div class="back-img">
                                <!-- Background Img -->
                                <img id="image-size" src="/assets/img/portfolio/<?= $portfolio['foto']; ?>" class="card-img-top" alt="...">
                            </div>
                        ...
                        <div class="card-body">
                            ...
                            <a href="/portfolio_describ/<?= $portfolio['slug']; ?>" class="btn tombol hvr-bounce-to-top">Selengkapnya</a>
                        </div>
                    </div>
                </div>
            <?php
    ...
    <div class="container">
        <div class="row row-biru">
            <div class="col d-flex flex-column align-items-center">
                ...
                <img src="/assets/img/mitra/Dinas.png" alt="" data-aos="fade-down">
            </div>
        </div>
        <!--Akhir Row1-->
        <!-- Testi -->
