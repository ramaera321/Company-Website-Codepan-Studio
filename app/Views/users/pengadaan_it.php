...
<!-- Jumbotron Heading -->
<div id="mt" class="centered jumbotron jumbotron-fluid" style="background-image: url('../img/pengadaan-it/Jumbotron\ Pengadaan\ IT.png');">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-5" id="judulSI" data-aos="fade-right">
                ...
                <p><a class="hvr-bounce-to-right" href="#">Dapatkan Konsultasi Gratis <i class="fas fa-long-arrow-alt-right"></i></a></p>
            </div>
