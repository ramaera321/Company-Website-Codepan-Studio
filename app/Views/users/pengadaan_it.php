    ...
    <div class="container" id="kunci-sukses">
        <div class="row">
            <div class="col">
                ...
                <h2 class="tag-besar">SYARAT IMPLEMENTASI PENGADAAN IT</h2>
        ...
        <div class="row" style="display: flex; justify-content: center;">
            <div class="col-sm-6" data-aos="zoom-out">
                <figure class="figure">
                    <img src="/assets/img/syarat-implementasi/card2.jpg" class="figure-img big img-fluid rounded" alt="...">
            ...
            <div class="col-sm-6" data-aos="zoom-out" data-aos-delay="200">
                <figure class="figure">
                    <img src="/assets/img/syarat-implementasi/card11.png" class="figure-img big img-fluid rounded" alt="...">
                    <figcaption class="figure-caption">
                        <h1>2. Tenaga Ahli</h1>
    ...
    <div class="container pembungkus-produk">
        <div class="row">
            <div class="col d-flex flex-column align-items-center">
                ...
                <h2 class="tag-besar">HASIL PRODUK LAYANAN KAMI</h2>
