...
<!-- Jumbotron Heading -->
<div id="mt" class="centered jumbotron jumbotron-fluid" style="background-image: url('../img/sistem-informasi/Jumbotron SI.png');">
            ...
            <div class="col-lg-3 col-md-6 mb-4 margin-rowCard">
                <div class="card h-100">
                    ...
                    <div class="card-img-rowCard">
                        ...
                        <lottie-player src="https://assets2.lottiefiles.com/packages/lf20_nl9bgfle.json" background="transparent" speed="1" style="width: 100px; height: 100px;" loop autoplay>
                        </lottie-player>
                    </div>
                    <div class="card-body">
                        <div id="counter">
            ...
            <div class="col-lg-3 col-md-6 mb-4 margin-rowCard">
                <div class="card h-100">
                    ...
                    <div class="card-img-rowCard">
                        ...
                        <lottie-player src="https://assets7.lottiefiles.com/packages/lf20_qdbb21wb.json" background="transparent" speed="1" style="width: 100px; height: 100px;" loop autoplay>
                        </lottie-player>
                    </div>
            ...
            <div class="col-lg-3 col-md-6 mb-4 margin-rowCard">
                <div class="card h-100">
                    ...
                    <div class="card-img-rowCard">
                        ...
                        <lottie-player src="https://assets9.lottiefiles.com/packages/lf20_tlzxty4j.json" background="transparent" speed="1" style="width: 100px; height: 100px;" loop autoplay>
                        </lottie-player>
                    </div>
                    <div class="card-body">
                        <div id="counter">
            ...
            <div class="col-lg-3 col-md-6 mb-4 margin-rowCard">
                <div class="card h-100">
                    ...
                    <div class="card-img-rowCard">
                        ...
                        <lottie-player src="https://assets1.lottiefiles.com/packages/lf20_2wrjlrbz.json" background="transparent" speed="1" style="width: 100px; height: 100;" loop autoplay>
                        </lottie-player>
