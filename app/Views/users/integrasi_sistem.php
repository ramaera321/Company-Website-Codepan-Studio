    ...
    <div class="container" id="kunci-sukses">
        ...
        <div class="row">
            ...
            <div class="col-lg-6 margin-figure" data-aos="zoom-out" data-aos-delay="300">
                <figure class="figure">
                    <img src="/assets/img/syarat-implementasi/card7.jpg" class="figure-img big img-fluid rounded" alt="...">
                    <figcaption class="figure-caption">
            ...
            <div class="col-lg-6 margin-figure" data-aos="zoom-out" data-aos-delay="400">
                <figure class="figure">
                    <img src="/assets/img/syarat-implementasi/card10.jpg" class="figure-img big img-fluid rounded" alt="...">
                    <figcaption class="figure-caption">
